...
class Enemies(models.Model):
    ...
    locations_found = models.ManyToManyField("Locations", blank=True)
...
class Quests(models.Model):
    ...
    monster_list = models.ManyToManyField(Enemies, blank=True)
...
class Locations(models.Model):
    ...
    enemies_there = models.ManyToManyField(Enemies, blank=True)
